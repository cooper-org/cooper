...
def test_manual_penalized(Toy2dCMP_params_init, device):
    ...
    const_contrib0 = const1_penalty_coefficient() * grad_x0_y0[1][0]
    const_contrib1 = const2_penalty_coefficient() * grad_x0_y0[1][1]
    ...
    const_contrib0 = const1_penalty_coefficient() * grad_x1_y1[1][0]
    const_contrib1 = const2_penalty_coefficient() * grad_x1_y1[1][1]
